...
template <>
struct luabridge::Stack<sihd::util::LatenessPolicy>: luabridge::Enum<sihd::util::LatenessPolicy,
...
struct luabridge::Stack<sihd::util::IdlePolicy>
    : luabridge::Enum<sihd::util::IdlePolicy, sihd::util::IdlePolicy::sleep, sihd::util::IdlePolicy::sleep_then_spin>
{
};
