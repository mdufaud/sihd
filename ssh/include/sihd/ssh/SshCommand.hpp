...
class SshCommand
{
    ...
    protected:
        ...
        static int ssh_command_channel_data_callback(ssh_session session, ssh_channel channel,
                                                    ...
                                                    void *userdata);
        static void ssh_command_exit_signal_callback(ssh_session session, ssh_channel channel,
                                                    const char *signal, int core,
                                                    const char *errmsg, const char *lang, void *userdata);
        static void ssh_command_exit_status_callback(ssh_session session, ssh_channel channel,
