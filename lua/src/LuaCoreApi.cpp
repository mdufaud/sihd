        ...
        .beginNamespace("sihd")
            .beginNamespace("core")
                .deriveClass<Device, sihd::util::Node>("Device")
                    ...
                    .addFunction("add_channel", static_cast<Channel *(Device::*)(const std::string &, const std::string &, size_t)>(&Device::add_channel))
                    .addFunction("add_unlinked_channel", static_cast<Channel *(Device::*)(const std::string &, const std::string &, size_t)>(&Device::add_unlinked_channel))
                ...
                .deriveClass<Channel, sihd::util::Named>("Channel")
                    ...
                    .addFunction("copy_to", +[] (Channel *self, IArray *array_ptr)
                    {
                    ...
                    .addFunction("read", +[] (Channel *self, size_t idx, lua_State *state)
                    {
                ...
                .endClass()
                .deriveClass<ChannelWaiter, ACoreObject>("ChannelWaiter")
                    .addConstructor<void (*)(Channel *)>()
                    .addFunction("set_channel", &ChannelWaiter::set_channel)
                    .addFunction("clear_channel", &ChannelWaiter::clear_channel)
                    .addFunction("wait_for", &ChannelWaiter::wait_for)
                .endClass()
