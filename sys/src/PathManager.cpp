                    ...
                    std::string & result_str)
{
    ...
    std::string path_to_search = (std::filesystem::path(path) / search).string();
    if (std::filesystem::exists(path_to_search))
    {
...
{
    if (!sihd::util::container::contains(_path_lst, path_item))
