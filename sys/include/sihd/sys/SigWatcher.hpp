#ifndef __SIHD_SYS_SIGWATCHER_HPP__
#define __SIHD_SYS_SIGWATCHER_HPP__
...
class SigWatcher: public sihd::util::Named,
                  public sihd::util::Configurable,
                  public sihd::util::Observable<SigWatcher>
{
    public:
        using Callback = std::function<void(int)>;

        SigWatcher(const std::string & name, sihd::util::Node *parent = nullptr);
    ...
    private:
        ...
        std::atomic<time_t> _polling_interval_ns;
};
