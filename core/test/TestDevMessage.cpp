...
namespace test
{
    ...
    TEST_F(TestDevMessage, test_devmessage)
    {
        ...
        auto [ch_active_in, ch_size_in, ch_str_in,
                ch_active_out, ch_size_out, ch_str_out,
                ch_buffer_in, ch_buffer_out, ch_trigger]
            = dev->get_channels("active_in", "size_in", "str_in",
                "active_out", "size_out", "str_out",
                "buffer_in", "buffer_out", "trigger");
